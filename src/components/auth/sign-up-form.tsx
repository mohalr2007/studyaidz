            ...
            <CardContent className="grid gap-4">
                <form action={signup} className="grid gap-4">
                    ...
                    <div className="relative">
                        ...
                        <Input id="email-signup" name="email" type="email" placeholder="البريد الإلكتروني" required className="pl-10 rtl:pl-0 rtl:pr-10" />
                    </div>
                    <div className="relative">
                        <KeyRound className="absolute left-3 rtl:left-auto rtl:right-3 top-1/2 -translate-y-1/2 h-5 w-5 text-muted-foreground" />
                        <Input id="password-signup" name="password" type="password" placeholder="كلمة المرور (6 أحرف على الأقل)" required className="pl-10 rtl:pl-0 rtl:pr-10" />
                    </div>
