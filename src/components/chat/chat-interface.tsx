            ...
            {messages.length === 0 && !isLoading && (
               <motion.div 
                ...
                >
                    ...
                    <h2 className="text-2xl font-semibold mb-2">Bienvenue sur votre Assistant IA Personnalisé</h2>
      ...
      <div className="p-4 pt-2">
         <Card className="p-2">
            ...
            <fieldset disabled={isLoading} className="group">
                    <div className="relative flex items-center gap-2 group-disabled:opacity-50">
                        <input
                            type="file"
                            ref={fileInputRef}
                        ...
                        <Button type="submit" size="icon" className="shrink-0 me-2 self-end">
