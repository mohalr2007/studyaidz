...
export const GmailLogo = ({ className }: { className?: string }) => (
    <svg xmlns="http://www.w3.org/2000/svg" width="32" height="32" viewBox="0 0 32 32" className={cn("h-8 w-8", className)}>
...
export const GoogleDriveLogo = ({ className }: { className?: string }) => (
    <svg xmlns="http://www.w3.org/2000/svg" width="32" height="32" viewBox="0 0 32 28" className={cn("h-7 w-8", className)}>
        <path fill="#1aa260" d="M21.328 28l5.333-9.333H10.66L5.328 28Z"/>
        <path fill="#34a853" d="M5.333 18.667L0 9.333l10.667-9.333L16 9.333Z"/>
        <path fill="#fcc934" d="m16 9.333l5.333-9.333h10.667l-5.333 9.333Z"/>
        <path fill="#0066da" d="m32 9.333l-5.333 9.334l-10.667-9.334L21.333 0Z"/>
    </svg>
);

export const YouTubeLogo = ({ className }: { className?: string }) => (
    <svg xmlns="http://www.w3.org/2000/svg" width="28" height="20" viewBox="0 0 28 20" className={className}>
